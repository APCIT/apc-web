...
/** POST: upload presentation file for intern; set Intern.PresentationId to new blob name.
...
export async function POST(
  ...
  try {
    ...
    const uploadPromise = uploadChecklistPresentationBlob(blobName, buffer);
